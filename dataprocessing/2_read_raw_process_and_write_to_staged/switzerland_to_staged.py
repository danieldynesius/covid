...
region_mapping = {
    'zurich': 'zürich',
    'lugano': 'ticino',
    'altenrhein': 'ostschweiz',
    'chur': 'ostschweiz',  # assuming chur is in the ostschweiz region
    'geneve': 'région lémanique',
    'laupen': 'espace mittelland'
}
...
metric_nm = 'sars_cov2_rna [gc/(d*100000 capita)]'
